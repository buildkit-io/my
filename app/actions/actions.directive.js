...
angular.module("bkApp").controller('actionsController', ['$scope', '$routeParams', '$firebaseObject', 'userService', 'tasksService', 'containerService', function($scope, $routeParams, $firebaseObject, userService, tasksService, containerService) {
		$scope.project = null;
